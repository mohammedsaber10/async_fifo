...
# DVE full session
# Saved on Sun Jul 17 23:16:29 2022
# Designs open: 1
#   Sim: /home/crazy/projects/async_fifo/sim/simv
# Toplevel windows open: 1
# 	TopLevel.1
#   Source.1: tb_top.unnamed$$_1
#   Group count = 2
...
#<Session mode="Full" path="/home/crazy/projects/async_fifo/sim/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{57 152} {1257 838}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 137} {height 385} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 281
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 203} {height 385} {dock_state left} {dock_on_new_line true} {child_data_colvariable 147} {child_data_colvalue 70} {child_data_coltype 87} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${DriverLoad.1} {{left 0} {top 0} {width 928} {height 179} {dock_state bottom} {dock_on_new_line false}}
...
if { ![gui_is_db_opened -db {/home/crazy/projects/async_fifo/sim/simv}] } {
gui_sim_run Ucli -exe simv -args { -ucligui} -dir /home/crazy/projects/async_fifo/sim -nosource
}
}
...
gui_sg_addsignal -group "$_session_group_1" { tb_top.w_if.wdata }

set _session_group_2 Group2
gui_sg_create "$_session_group_2"
set Group2 "$_session_group_2"

gui_sg_addsignal -group "$_session_group_2" { tb_top.w_if.wclk }
...
catch {gui_list_select -id ${Hier.1} {tb_top.w_if}}
...
gui_list_show_data -id ${Data.1} {tb_top.w_if}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {tb_top.w_if.wclk }}
...
gui_open_source -id ${Source.1}  -replace -active {tb_top.unnamed$$_1} /home/crazy/projects/async_fifo/sim/tb_top.sv
gui_view_scroll -id ${Source.1} -vertical -set 135
gui_src_set_reusable -id ${Source.1}
# Warning: Class view not found.

# DriverLoad 'DriverLoad.1'
gui_get_drivers -session -id ${DriverLoad.1} -signal tb_top.r_if.rrst_n -time 0 -starttime 0
gui_get_drivers -session -id ${DriverLoad.1} -signal {tb_top.w_if.wdata[7:0]} -time 0 -starttime 0
gui_get_drivers -session -id ${DriverLoad.1} -signal tb_top.w_if.wclk -time 3966 -starttime 3966
